...
## Video
Click [![image](https://github.com/user-attachments/assets/6aade60c-ca41-40a3-be6a-c63499b0e288 | width=200)](https://1drv.ms/v/s!AsL2ZaC8wozAh6ZOOApmysKH1pyEUA?e=Ccg73W) to watch the video demonstration of the output. For a deeper understanding of the project's development and the K-means algorithm implementation, you can explore the **`development_and_analysis`** directory. In 2nd file of **`development_and_analysis`** there's explanation of Concept of K-means.
